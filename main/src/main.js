...
class App extends React.Component {
  ...
  goNext() {
    ...
    if (newPage === 3) { // submit questionnaire
    ...
    if (newPage === 7 && this.state.responses[12] === 1) {
  ...
  render() {
    ...
    if (this.state.page === 1) {
      content = <div className='main-div'>
        ...
        <p className='main-instructions-more'>This experiment poses no risk over and above the ordinary risks posed by reasoning and using a computer. By checking the checkbox below, you are consenting to being part of this experiment and having your responses collected by the experimenters. Your participation is entirely voluntary, and you may withdraw your consent and terminate your participation in the experiment at any point. In this event, you will still receive the compensation for the time you spent in the experiment at the rate of $10 per hour, but will not receive the $7.50 bonus.</p>
    ...
    if (this.state.page === 3) {
      content = <div className='main-div'>
        ...
        <FormQuestion
          ...
          options={["Thinking aloud means giving a detailed account of all your thoughts.", "Thinking aloud was studied in the 20th century in both speech, as well as written forms.", "Thinking aloud provides clues we can use to learn a lot about people's thought processes."]}
    ...
    if (this.state.page === 6) {
      content = <div className='main-div'>
        <p className='main-instructions'>For the first stage of this experiment, you will be asked to solve a puzzle. The instructions will first be displayed on the right side of the screen, so you should begin there. If you find that your screen cannot display all the content without requiring you to scroll around sideways, please resize your screen or "zoom out" until you can see all the content without having to scroll.</p>
        <p className='main-instructions-more'>After you finish reading the instructions, you will find a text entry box for you to "think aloud" with on the bottom of the screen, much as you did in the previous screen. Please use it as described in the previous screen, giving clues to your thoughts as you are thinking through and solving the puzzle. Be very thorough in recording your thoughts - anything that comes to your mind is of interest to us. This includes hunches, ideas, plans, feelings, and others, in addition to the more concrete thoughts you might have recorded in the previous screen. If you spend a long time without recording a thought, a pop-up will appear reminding you to record your thoughts. If this happens, please record anything that has entered your mind about the problem since the last prompt.</p>
