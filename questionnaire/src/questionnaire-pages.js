...
export class QuestionnairePage1 extends React.Component {
  ...
  render() {
    const prompts = [
      'Think back to the very beginning when you were first introduced to the puzzle. What did you think and do in the first two minutes?',
      'In the first two minutes of the puzzle, what were the things you initially noticed about the puzzle and its components? List all observations you recall making initially.',
...
export class QuestionnairePage3 extends React.Component {
  constructor(props) {
    ...
    let q1Options = [
      ...
      '"Abutting squares are always of opposite colors."',
